...
const dict: {[lang: string]: {[key: string]: any}} = {
  "en": {
    ...
    "quiz.files-too-large": "Total file size must not exceed 50 MB",
    ...
    "quiz.dont-forget-to-submit-file": (n: number) => `${n === 1 ? "This file is" : "These files are"} not uploaded yet! Click Submit to upload ${n === 1 ? "it" : "them"}.`,
    "quiz.submit-will-replace": (n: number) => `Submitting ${n === 1 ? "this file" : "these files"} will replace the existing upload.`,
  ...
  "sl": {
    ...
    "quiz.files-too-large": "Skupna velikost datotek ne sme presegati 50 MB",
    ...
    "quiz.dont-forget-to-submit-file": (n: number) => `${n === 1 ? "Ta datoteka še ni naložena!" : n === 2 ? "Tidve datoteki še nista naloženi" : "Te datoteke še niso naložene!"} Kliknite Oddaj, da ${n === 1 ? "jo" : n === 2 ? "ju" : "jih"} naložite.`,
    "quiz.submit-will-replace": (n: number) => `Oddaja ${n === 1 ? "te datoteke" : n === 2 ? "teh dveh datotek" : "teh datotek"} bo zamenjala obstoječo oddajo.`,
